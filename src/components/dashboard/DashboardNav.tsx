      ...
      <div className="max-w-[1200px] mx-auto px-6 flex items-center justify-between h-14">
        <div className="flex items-center gap-8">
          <Link href="/dashboard" className="flex items-center gap-2">
            ...
            <span className="text-[0.65rem] text-text-muted bg-bg-warm px-1.5 py-0.5 rounded ml-0.5">
              Coach
            </span>
          </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <form action={logout}>
            <button
              type="submit"
              className="flex items-center gap-1.5 px-3 py-1.5 text-sm text-text-muted hover:text-red-500 transition-colors cursor-pointer"
            >
              <LogOut size={14} />
