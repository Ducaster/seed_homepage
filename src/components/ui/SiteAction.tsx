...
export default function SiteAction({
  ...
  const contentByKind = useMemo<Record<SiteActionKind, ActionContent>>(
    () => ({
      plan: {
        title: "상담 신청이 접수되었습니다",
        eyebrow: "신청 완료",
        description:
          "선택하신 플랜을 기준으로 상담 신청이 접수되었습니다. 담당 코치가 신청 내용을 확인한 뒤 순차적으로 연락드립니다.",
          ...
          <div className="space-y-3 text-sm text-seed-earth-700">
            <div className="rounded-xl bg-seed-green-50 p-4">
              ...
              <p className="mt-1 text-seed-green-700">
                접수번호 SEED-{new Date().getFullYear()}-
                {String(new Date().getMonth() + 1).padStart(2, "0")}
                {String(new Date().getDate()).padStart(2, "0")}
              </p>
            </div>
            <p>상담 가능 일정과 프로그램 안내를 확인해 연락드립니다.</p>
            <p>
              신청 내용은 접수 순서대로 확인되며, 영업일 기준 1-2일 내
              안내됩니다.
            </p>
          </div>
        ),
        ...
        body: (
          <div>
            ...
            <LegalParagraph>
              ...
              없이 파기합니다. 단, 관련 법령에 따라 보관이 필요한 정보는
              법령에서 정한 기간 동안 보관할 수 있습니다.
            </LegalParagraph>

            <SectionTitle>4. 개인정보의 제3자 제공</SectionTitle>
            <LegalParagraph>
              SEED는 이용자의 동의 없이 개인정보를 외부에 제공하지 않습니다.
              다만 법령에 근거한 요청이 있는 경우에는 예외적으로 제공될 수
              있습니다.
            </LegalParagraph>
            ...
            <LegalParagraph>
              이용자는 본인의 개인정보에 대해 열람, 정정, 삭제, 처리정지를
              요청할 수 있습니다. 요청은 문의 채널을 통해 접수할 수 있으며,
              SEED는 관련 법령에 따라 지체 없이 처리합니다.
            </LegalParagraph>
      ...
      contact: {
        title: contactSent ? "문의가 접수되었습니다" : "문의하기",
        eyebrow: contactSent ? "접수 완료" : "SEED 운영팀",
        description: contactSent
        ...
        body: contactSent ? (
          ...
          >
            ...
            <button
              type="submit"
              className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-seed-green-600 px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-seed-green-700"
            >
        ...
        actionLabel: contactSent ? "확인" : undefined,
      },
    }),
    [contactSent, detailLabel],
  );
