      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-card rounded-[var(--radius-md)] shadow-[var(--shadow-sm)] p-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-medium text-text">
                {disintegrationInfo.name}
              </p>
              <p className="text-xs text-text-muted">
                {disintegrationInfo.alias}
              </p>
            </div>
          </div>
        </div>
          ...
          {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((t) => {
            ...
            return (
              <div key={t} className="flex items-center gap-3">
                <span
                  className={`w-6 text-right text-xs font-bold ${isMain ? "text-primary" : "text-text-muted"}`}
                >
                  {t}
                </span>
                <span
                  className={`w-16 text-xs truncate ${isMain ? "text-primary font-medium" : "text-text-muted"}`}
                >
                  {info.name}
                </span>
                ...
                <span
                  className={`w-12 text-right text-xs ${isMain ? "text-primary font-bold" : "text-text-muted"}`}
                >
                  {score}점
                </span>
              </div>
